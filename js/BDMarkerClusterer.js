...
(function(){
    ...
    MarkerClusterer.prototype.addAndRemoveMarkers = function(addMarkers, removeMarkers) {
      for (var i = 0; i < removeMarkers.length; i++) {
        this._removeMarker(removeMarkers[i]);
      }

      for(var i = 0, len = addMarkers.length; i <len ; i++){
        this._pushMarkerTo(addMarkers[i]);
      }
    ...
    MarkerClusterer.prototype.resetCluster = function() {
      this._redraw();
    };
